...
metadata families. The first contract translates edited XMP creation dates into
native EXIF and IPTC date groups before transfer or writing.
...
2. Call `translate_xmp_creation_dates(...)` with explicit mapping and conflict
   options.
