...
2. [partial in 0.4.103] Refactor TIFF/DNG and TIFF-based camera RAW header/IFD
   ...
   derived tables are also converted. Mixed-base Fuji, Kodak, Ricoh, Nintendo,
   Casio, Minolta, and FLIR paths plus Canon external derived subtables stay
   explicit residuals.
